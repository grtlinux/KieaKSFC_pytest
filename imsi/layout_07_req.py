...
def makeField(line):
    ...
    global _data, _sCode, _bReqFlag, _sArrName
    if _bReqFlag:
        # print('>>>', line)
        ...
        if '<object>' in line:
            ...
            if ' N(' in line:
                try:
                    _data[arr[0]] = int(arr[4])
                except ValueError:
                    _data[arr[0]] = float(arr[4])
            else:
                _data[arr[0]] = arr[4]
    pass
